...
import { ArrowLeft, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2Icon, Sparkle, User } from "lucide-react";
import PersonalinfoForm from "../components/PersonalinfoForm";
import ResumePreview from "../components/ResumePreview";
import TemplateSelector from "../components/TemplateSelector";
import ColorPicker from "../components/ColorPicker";
import ProfessionalSammaryForm from "../components/ProfessionalSammaryForm";
              ...
              <div>
                ...
                <div>
                  ...
                  {activeSection.id === 'summary' && (
                    <div>
                      <ProfessionalSammaryForm data={resumeData.professional_summary} onChange={(data) => setResumeData(prev => ({ ...prev, professional_summary: data }))} setResumeData={setResumeData} />
                    </div>
                  )}
                ...
                <button onClick={()=>{toast.promise(saveResume,{loading:'Saving...'})}} className="bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 ring hove:ring-green-400 trantion-all rounded-md px-6 py-2 mt-6 text-sm">
                  Save Changes
                </button>
              </div>
            </div>
